...
class ExchangeManager:
    ...
    async def _create_exchange(self, exchange_name: str, config: Dict) -> Optional[ccxt.Exchange]:
        """
    ...
    async def get_ticker(self, symbol: str, exchange_name: str = None) -> Optional[Dict]:
        """
    ...
    async def get_trading_fees(self, symbol: str, exchange_name: str = None) -> Optional[Dict]:
        """
