...
class RiskManager:
        ...
        try:
            ...
            for i, risk_i in enumerate(position_risks):
                for j, risk_j in enumerate(position_risks):
                    ...
                    portfolio_variance += weights[i] * weights[j] * risk_i * risk_j * correlation
    ...
    async def _check_volatility_risk(self, symbol: str, signal: Dict) -> Dict:
        ...
        try:
            ...
            return {
                'approved': True,
                'reason': 'Volatility risk acceptable'
            }
        ...
        try:
            ...
            if last_price > 0 and current_price > 0:
                ...
                if len(vol_data['returns']) >= 5:
                    ...
                    volatility = np.std(returns_array) * math.sqrt(1440)  # Annualized (1440 minutes per day)
    ...
    async def update_pnl(self, pnl: float):
        ...
        try:
            ...
            if self.portfolio_value > self.max_drawdown:
                ...
                self.current_drawdown = (self.max_drawdown - self.portfolio_value) / self.max_drawdown
